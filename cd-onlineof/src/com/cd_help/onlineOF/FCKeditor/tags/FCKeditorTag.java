...
package com.cd_help.onlineOF.FCKeditor.tags;
...
public class FCKeditorTag extends BodyTagSupport  {
	private static final Log log = LogFactory.getLog(FCKeditorTag.class);
	private String id;
	...
	/**
	 * 
	 * Constructs a <code>FCKeditorTag</code>
	 * @since cd_help-onlineOF 0.0.0.1
	 */
	public FCKeditorTag(){
		log.debug("FCKeditorTag Init....");
	}
